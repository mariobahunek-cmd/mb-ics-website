...
const testimonialData = [
    ...
    },
    {
        ...
        quote: {
            de: "Die Probeklausuren waren der Schlüssel zu meinem Erfolg. Ich habe die Foundation-Prüfung mit Auszeichnung bestanden! Kann ich nur weiterempfehlen.",
            en: "The practice exams were the key to my success. I passed the Foundation exam with distinction! Highly recommended.",
            es: "Los exámenes de práctica fueron la clave de mi éxito. Aprobé el examen Foundation con distinción. ¡Muy recomendable!"
        },
        source: "email"
    },
    {
